...
const ProductPage = () => {
    ...
    const addToBasketHandler = () => {
        BasketService.addToBasket(productId)
            .then((response) => {
                dispatch(
                    addToastTime("success", "Товар успешно добавлен в корзину!")
                );
                setIsBasket(true);
            })
            .catch((e) => {
                ...
                <div className="product-page__data">
                    <div className="product-page__main">
                        ...
                        <div className="product-page__controlls">
                            {isBasket ? (
                                <CustomBtn onClick={e=>navigate("/basket")}>В корзине</CustomBtn>
                            ) : (
                                <CustomBtn onClick={addToBasketHandler}>Добавить в корзину</CustomBtn>
                            )}
